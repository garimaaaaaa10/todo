    ...
    return (<>
        <div className="todo">
            ...
            <div className="todo-main container d-flex justify-content-center align-items-center my-4 flex-column">
                ...
                <div className=" w-lg-50 w-100 d-flex justify-content-end my-3"><button className="home-btn px-2 py-1" onClick={submit}>
                    Add
                </button></div>
        ...
        <div className="todo-update" id="todo-update">
            ...
            <div className="container update" id="update">
